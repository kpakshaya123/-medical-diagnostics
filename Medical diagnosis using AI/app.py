...
width: 50%;
height: 50%;
background-color: rgba(0,0,0,0.5);  /* Slightly dark but still allows the image to show through */
h1, h2, h3, h4, h5, h6, p {{
    color: white;  /* Ensure text is white */
    text-shadow: 2px 2px 5px rgba(0.5, 0.5, 0.5, 0.7);  /* Add text shadow for better visibility */
}}
}}
</style>
"""
